...
function extractRecommendedFields(rawText, requestId) {
  ...
  const recommendedText = normalizeThaiTranscriptionText(
    source.text ||
  ...
  const recommendedSpeed = normalizeThaiRecommendedSpeed(
    source.speed ||
      ...
      return {
        ...
        meta: {
          ...
          models: {
            ...
            recognitionStrategy: "thai_transcription_speed",
