...
1. `/items?taskId={taskId}&role={reviewRoleId}&itemId={itemId}&selectIds={itemId}&viewMode=true&nodeId={reviewNodeId}`
2. 初始化查看页请求链路。
3. 页面展示只读 `same_font`、派生字段、资源区和右侧信息。
