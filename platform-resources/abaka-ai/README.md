...
| 项目 | 目录 | 当前阶段 | 资料入口 |
| --- | --- | --- | --- |
| Task21 | `platform-resources/abaka-ai/task21/` | same_font 专项链路已采集，已上线 Task21助手（快捷键 + AI 辅助填写；image_b_texts_removed 已升级为 T/B/R/D 多重集判断，规则为 `D == T => true`、`D` 为空 => `null`、其余 `specify`） | `task21/README.md` |
...
- Task 页面动作与状态边界：`actions.md`
- Task 页面多语言文案：`i18n.md`
