...
- 新增 `platform-resources/bytedance-aidp/jinhua-helper/ai/assets/jinhua-lexicon.json`
  ...
  - 全量保留 `单字 / 词汇 / 语法` 展开后的 `3655` 条 entry
  - 对源文档中缺少金华话写法或普通话含义的异常条目标记 `needsReview`
- 新增 `platform-resources/bytedance-aidp/jinhua-helper/ai/assets/jinhua-pronunciation-reference.csv`
  - 全量保留单字、词汇、语法的发音参考记录
  - 多读音、多写法、多句式拆分为独立行，不合并丢失
- 更新 `platform-resources/bytedance-aidp/jinhua-helper/ai/adapter.js`
  - 注册 `jinhua-lexicon.json` 与 `jinhua-pronunciation-reference.csv` 为可选 AI 资产
- 新增 `platform-resources/bytedance-aidp/jinhua-helper/ai/adapter.test.js`
  - 回归覆盖金华话 adapter 资产注册、词表 schema 与 CSV 基础行数
- 更新文档：
  - `platform-resources/bytedance-aidp/README.md`
  - `platform-resources/bytedance-aidp/jinhua-helper/README.md`
  - `platform-resources/bytedance-aidp/jinhua-helper/backend/README.md`
  - 明确当前只注册资产，不把全量词表直接展开进 AI prompt
