...
const RETAINED_PLATFORM_IDS = ["bytedanceAidp", "dataBakerCvpc", "magicData", "shujiajia"];
...
test("catalog contains the six promoted scripts", function () {
  const constants = loadConstants();
  ...
  assert.equal(constants.SCHEMA_VERSION, 42);
});
