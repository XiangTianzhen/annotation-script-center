...
const contentModulePath = resolveRepo("extension", "sites", "data-baker-cvpc", "liuzhou-helper", "content.js");
const concurrentStreamFactory = require(resolveRepo(
  "extension",
  "shared",
  "concurrent-ai-request-stream.js"
));
