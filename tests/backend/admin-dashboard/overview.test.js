...
} = require(resolveRepo("platform-resources", "backend", "admin-dashboard", "overview.js"));
...
test("admin dashboard overview returns pool occupancy and runtime log summary payload", function () {
  ...
  assert.equal(overview.data.logsSummary.latestFailure.scope, "admin.ai_call_log");
