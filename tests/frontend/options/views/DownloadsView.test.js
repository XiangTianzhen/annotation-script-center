...
describe("DownloadsView ZIP-only release center", () => {
  beforeEach(() => {
    ...
    downloadsStore.releases = {
      ...
      items: [
        ...
        },
        {
          ...
          zipUrl: "https://example.com/prev.zip",
          notes: [],
        },
      ],
    };
  ...
  test("renders the legacy summary and release panel anchors", () => {
    ...
    expect(wrapper.text()).toContain("仅 ZIP");
    expect(wrapper.text()).toContain("下载 ZIP");
    expect(wrapper.text()).toContain("开发者模式");
    expect(wrapper.text()).not.toContain("CRX");
