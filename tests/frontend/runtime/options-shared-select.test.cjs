...
const sharedSelectPath = resolveRepo(
  "frontend",
  "options-app",
  "runtime-modules",
  "options-shared-select.cjs"
);
const htmlPath = resolveRepo("frontend", "options-app", "options.html");
const baseSelectPath = resolveRepo(
  "frontend",
  "options-app",
  "src",
  "components",
...
const scriptDetailViewPath = resolveRepo(
  "frontend",
  "options-app",
  "src",
  "views",
...
const scriptSettingsFieldsPath = resolveRepo(
  "frontend",
  "options-app",
  "src",
  "components",
  "script-detail",
  "ScriptSettingsFields.vue"
);
const adminExportsViewPath = resolveRepo(
  "frontend",
  "options-app",
  "src",
  "views",
  "AdminExportsView.vue"
);
const adminBackendViewPath = resolveRepo(
  "frontend",
  "options-app",
  "src",
  "views",
  "AdminBackendView.vue"
);
const downloadsViewPath = resolveRepo(
  "frontend",
  "options-app",
  "src",
  "views",
...
test("options source wires shared custom-selects for detail, admin exports, and downloads", function () {
  ...
  const scriptSettingsFields = fs.readFileSync(scriptSettingsFieldsPath, "utf8");
  ...
  assert.match(scriptDetailView, /<ScriptSettingsFields/);
  assert.match(scriptSettingsFields, /:custom="true"/);
