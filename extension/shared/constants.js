...
(function () {
  ...
  const ABAKA_AI_TASK21_VISION_MODEL_OPTIONS = [
    {
      ...
      docUrl: BAILIAN_DOC_URLS.visionUnderstanding,
    },
    {
      ...
      supportsJsonObject: true,
      docUrl: BAILIAN_DOC_URLS.imageVideoUnderstanding,
    },
    {
  ...
  const ABAKA_AI_TASK21_REASONING_MODEL_OPTIONS = [
    {
      value: "qvq-plus-latest",
      label: "qvq-plus-latest",
      role: "reasoning",
      callMode: "openai-compatible-chat",
      supportsVision: true,
      supportsOcr: false,
      supportsThinking: true,
      supportsJsonObject: true,
      docUrl: BAILIAN_DOC_URLS.visualReasoning,
    },
    {
      value: "qwen3.5-plus",
      label: "qwen3.5-plus",
      ...
      supportsThinking: true,
      supportsJsonObject: true,
      docUrl: BAILIAN_DOC_URLS.modelList,
    },
  ];
