...
- `0.3.7` 热修口径：Magic Data 客家话助手后端在 AI 响应出口统一做普通中文繁转简，并保留客家话统一用字。
...
- Magic Data 客家话助手：后端 AI 响应出口新增普通中文繁转简收口，结果区、行内建议、听音文本与 legacy comparison 推荐文本默认输出简体，并保留客家话统一用字。
