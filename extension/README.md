...
- `abaka-ai/task-page/`：Abaka AI Task 页面结构采集；运行时说明见 `sites/abaka-ai/task-page/README.md`，平台资料见 `platform-resources/abaka-ai/task-page/README.md`，只记录脱敏 DOM/Network 结构，不做自动领取、自动保存、自动提交、自动流转。
