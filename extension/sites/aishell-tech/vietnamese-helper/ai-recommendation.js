(function () {
  if (globalThis.__ASREdgeAishellTechVietnameseAiRecommendationInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechVietnameseAiRecommendationInstalled = true;
  ...
  const RECOMMEND_PATH =
    constants.AISHELL_TECH_VIETNAMESE_AI_RECOMMEND_PATH || "/api/aishell-tech/vietnamese-helper/ai/recommend";
  ...
  globalThis.__ASREdgeAishellTechVietnameseAiRecommendation = api;
})();
