(function () {
  if (globalThis.__ASREdgeAishellTechThaiAiRecommendationInstalled === true) {
    return;
  }
  globalThis.__ASREdgeAishellTechThaiAiRecommendationInstalled = true;
  ...
  const RECOMMEND_PATH =
    constants.AISHELL_TECH_THAI_AI_RECOMMEND_PATH || "/api/aishell-tech/thai-helper/ai/recommend";
  ...
  globalThis.__ASREdgeAishellTechThaiAiRecommendation = api;
})();
