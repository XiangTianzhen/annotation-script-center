(function () {
  ...
  function createRuntime(options) {
    ...
    function handleKeydown(event) {
      ...
      if (actionKey === "copyAiHeardText" && typeof actions.copyHeardText === "function") {
        runPromiseAction(actions.copyHeardText(), actions);
        return;
      }
  ...
  globalThis.__ASREdgeAishellTechMinnanShortcuts = {
    createRuntime,
  };
})();
