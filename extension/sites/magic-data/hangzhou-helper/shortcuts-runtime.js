(function () {
  const LEGACY_STORAGE_KEY = "scriptCenter.magicDataHangzhouAssistant.shortcuts";
  const ACTION_DEFINITIONS = [
    ...
    { key: "toggleDialectDetail", label: "展开/收起杭州话内容详情" },
  ...
  async function loadShortcutMapFromSettings() {
    ...
    try {
      ...
      const projectSettings = settings?.scriptCenter?.projects?.magicDataHangzhouAssistant || {};
      return {
  ...
  globalThis.__ASREdgeMagicDataHangzhouShortcuts = {
