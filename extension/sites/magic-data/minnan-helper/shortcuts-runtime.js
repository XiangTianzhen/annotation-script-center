(function () {
  const LEGACY_STORAGE_KEY = "scriptCenter.magicDataMinnanAssistant.shortcuts";
  ...
  async function loadShortcutMapFromSettings() {
    ...
    try {
      ...
      const projectSettings = settings?.scriptCenter?.projects?.magicDataMinnanAssistant || {};
      return {
  ...
  globalThis.__ASREdgeMagicDataMinnanShortcuts = {
