...
- Magic Data AI 面板统一配置项：模型方案、识别策略、听音模型、比较模型、单模型、thinking、Prompt 与生成参数；不再展示 `AI 质检模式`。
...
- 2026-05-27 热修：客家话助手后端在响应出口统一做普通中文繁转简；行内建议、结果区推荐文本、听音文本和 legacy comparison 推荐文本默认输出简体，客家话统一用字继续保留。
