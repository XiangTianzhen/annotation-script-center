...
1. 先读 `AGENTS.md`
2. 处理具体平台时再读 `docs/platforms-index.md`
3. 涉及百炼能力时再读 `docs/external-docs-aliyun-bailian.md`
4. 遇到企业托管自动安装问题时再读 `docs/unfinished-crx-enterprise-managed-install.md`
5. 历史过程统一查看 `log.md`
