...
- `judgement-compact-card.js` 会监听 `.labelRender-item[data-index]`，开关开启时在每个题卡根节点下显示扩展摘要块。
...
9. 在快判设置中确认“轻量题卡摘要”开启，保存并刷新详情页，确认每个题卡显示扩展摘要块，并包含 `asr_text1`、`asr_text2` 与“哪个ASR更优”的当前状态。
