...
- 页面 URL 样例：`https://labelx.alibaba-inc.com/corpora/labeling/labelingTask?projectId=1023`
...
- 首屏是否异步加载：是
- 本次观察到的关键接口：
  - `GET /api/v1/label/center/subTasks?type=label&keyword=&appId=1023&finished=false&page=1&pageSize=5...`
  - `GET /api/v1/label/center/tasks?subTaskType=label&keyword=&appId=1023&page=1&pageSize=5...`
